    ...
    <main className="px-6 py-20 max-w-5xl mx-auto space-y-24">
      ...
      <section id="demo" className="scroll-mt-20">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-3">See QAgenAI in Action</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Watch how QAgenAI transforms a simple requirement document into a comprehensive test suite
          </p>
        </div>
